...
The following prompt configures the AI agent behavior. Store in `lib/prompts.ts`:
...
export const FUNCTIONS = [
  ...
  },
  {
    ...
    description: "Calculate restock recommendation for a SKU with optional variable overrides",
    parameters: {
      type: "object",
      properties: {
        sku_number: { type: "string" },
        lead_time_days: { type: "number", description: "Override lead time" },
        safety_days: { type: "number", description: "Override safety days" },
        restock_cadence_days: { type: "number", description: "Override restock cadence" },
  ...
  },
  {
    ...
    description: "Search the knowledge base for supply chain information",
    parameters: {
      type: "object",
      properties: {
